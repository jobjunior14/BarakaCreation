...
function LogoDetail ({images,text, title, state, hideDetails }) {
    ...
    return (<div className={`${ state ? 'absolute' : 'hidden'} p-5 sm:p-7 md:px-10 lg:px-[8%] w-full flex flex-col justify-center items-center gap-5 bg-slate-200 relative rounded-xl`}>
        ...
        <secton className=' flex items-center justify-center w-full px-5 gap-2'>
...
export default function Logofolio () {
    ...
    const [showDetails, setShowDetails] = useState({
        ...
        j: false, k: false, l: false, m: false, n: false, o: false, p: false, q: false,
        r: false, s: false, t: false, u: false, v: false, w: false, x: false, y: false,
        z: false, aa: false, bb: false, cc: false, dd: false, ee: false, ff: false, gg: false,
        hh: false, ii: false, jj: false, kk: false, ll: false, mm: false,
        ...
        hidden: function () {
          ...
          this.aa || this.bb || this.cc || this.dd || this.ee || this.ff || this.gg || this.hh || this.ii || this.jj || this.kk || this.ll || this.mm   
        } 
    });
    ...
    return (
        <main className="w-full flex flex-col gap-5 relative">
            <div className={` ${showDetails.hidden() ? 'sticky' : 'hidden'} absolute top-5 z-40 backdrop-blur-md   w-full h-[100vh]  justify-center items-center flex px-[2%]`}>
            ...
            <section className="grid grid-cols-2 sm:grid-cols-3 w-full gap-2 px-[2%] bg-slate-300 py-5 sm:px-[10%]" >
                ...
                <div onClick={() => handleDetails('f')}  className='bg-cover cursor-pointer bg-center flex justify-center items-center w-full h-[10rem] sm:hover:scale-105 duration-150 sm:hover:-translate-x-5 sm:hover:-translate-y-2 rounded-lg ' style={{backgroundImage: `url(${Logo_Odej_1})`}}>
