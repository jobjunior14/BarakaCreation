        ...
        {canPlay >= 1 ? 
            <div className="w-full h-full relative flex flex-col justify-center items-center  bg-bgRemporter1 ">
                ...
                {width <=640 && <div className="absolute top-[10vh] flex flex-col gap-3 justify-center items-center">
                    { audioRef.current.paused && <p className={`text-gray-200 text-xs font-semibold `}>Votre Navigateur ne peut jouer de la musique automatiquement, S&apos;il vous plait veuillez appuyer sur <b>Play</b></p>}
