                ...
                <ul className='flex flex-col lg:flex-row lg:items-center justify-evenly mainDiv'>
                    ...
                    <li className='flex justify-start flex-col mb-10 lg:mb-0 lg:mx-5'>
                        ...
                        <div className={`w-fit lg:hidden overflow-hidden ${toggleNav.services ? 'h-[6.25rem]' : 'h-0'} transition-all `}>
                            <ul className='pl-2 list-none flex flex-col gap-2 pt-3'>
                                ...
                                <li onClick={toggle} className='text-gray-700 text-xs hover:list-disc font-semibold'> <NavLink className={({isActive}) => !isActive ? ' opacity-45 hover:opacity-100 duration-200' : 'bg-none hover:opacity-45' } to={'/services/motionDesign'}>Animation</NavLink></li>
                    ...
                    <li className='flex justify-start flex-col mb-10 lg:mb-0 lg:mx-5'>
                        ...
                        <div className={`w-fit lg:hidden overflow-hidden ${toggleNav.portfolio ? 'h-[6.25rem]' : 'h-0'} transition-all `}>
                            <ul className='pl-2 list-none flex flex-col gap-2 pt-3'>
                                <li onClick={toggle} className='text-gray-700 text-xs hover:list-disc font-semibold'> <NavLink className={({isActive}) => !isActive ? ' opacity-45 hover:opacity-100 duration-200' : 'bg-none hover:opacity-45' } to={'/portfolio/galleryArt'}>Illustrations </NavLink></li>
