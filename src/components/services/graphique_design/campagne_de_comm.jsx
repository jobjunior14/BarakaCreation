...
export default function CampagneDeComm () {
    ...
    return (
        <main>
            ...
            <section className=' bg-bgCampagnCom w-full grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-5 md:gap-7 px-[4%] sm:px-[5%] md:px-[10%] lg:px-[15%] py-9'>
