            ...
            <div className=' sm:px-[5rem] md:px-[6.25rem] lg:px-[7.5rem] bg-myBlue w-full flex flex-col gap-6 md:gap-10  p-5'>
                ...
                <section className='w-full grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-10'>
                    ...
                    <div className='w-full px-[15%] sm:px-0'>
                        <p className='text-left font-interSemibold text-gray-100 text-[0.875rem] sm:text-[15px] md:text-[17px] leading-5  sm:w-[75%] md:w-[70%] lg:w-[65%] '>Un puissant message qui permet de capter l&apos;attention de votre public et transmettre des messages de maniere claire et concise.</p>
                    </div>
                    
                    {/* second paragraph  */}
                    <div className='w-full px-[15%] sm:px-0'>
                        <p className='text-left font-interSemibold text-bgPlay text-[0.875rem] sm:text-[15px] md:text-[17px] leading-5'>Nous créons des animations personalisées et qui reflètent votre message. <br /> Nous vous accompagnons durant tout le processus du briefing au rendu final.</p>
                    </div>
                ...
                <section className='grid grid-cols-1 gap-6 md:gap-10 px-[5%] sm:px-[10%]  text-left'> 
                    <div>
                        <h1 className=' text-blue-100 text-[1.5rem] sm:text-[1.2rem] md:text-[1.75rem] lg:text-[1.875rem] font-interBold leading-7 w-[70%]' >Votre partenaire créatif pour la préproduction des dessins animés</h1>
                    </div>
                   
                    <div>
                        <p className='font-interSemibold text-blue-50 text-[0.93rem] sm:text-[1rem] md:text-[1.1rem] lg:text-[1.25rem] leading-5'>Nous vous accompagnons durant tout le processus, du biefing à la post-production, passant par le développement de votre univers visuel et la ligne graphique</p>
                    </div>
